...
# immigration data
def process_immigration(input_data, data_file, output_data):
...
# Tempreture
def process_temperature(input_data, data_file, output_data):
    """ process immigration raw data, then load into S3 bucket in Parquet format
...
# airports data
def process_airports(input_data, data_file, output_data):
...
# demographic
def process_us_demographic(input_data, data_file, output_data):
