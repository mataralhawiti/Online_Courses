...
def process_song_file(cur, filepath):
    ...
    to get song and artist metadata, then populate songs and artists tables.
...
def process_log_file(cur, filepath):
    ...
    to get time data and users data. Then, populate time, users, and songplays tables.
...
def process_data(cur, conn, filepath, func):
    """
    Description: this function can be used to get list of files in filepath (data/song_data) aor (data/log_data), 
    according to the passed func paramenter.Then, read file will be processed.
    
    Argemnts:
        cur: the cursor object.
        conn: the connection object.
        filepath: log data file path.
        func: func object that specifies what function to call
