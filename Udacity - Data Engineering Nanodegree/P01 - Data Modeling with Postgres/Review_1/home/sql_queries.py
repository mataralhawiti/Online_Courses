...
(songplay_id SERIAL PRIMARY KEY, start_time BIGINT, user_id INT DEFAULT NULL, level CHAR(4), song_id VARCHAR, artist_id VARCHAR, session_id INT, location VARCHAR, user_agent TEXT);
""")
