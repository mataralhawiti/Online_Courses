"""
Defining Your First Avro Record
"""
...
class ClickEvent:
    ...
    def serialize(self):
        ...
        out = BytesIO()
        """
        BytesIO() object, because fastavro has to write the data to file-like object.
        we're not interesting in wrritng to disk, we want to keep it in memory
