...
async def produce(topic_name):
	...
	while True:
		...
		# we'll call poll() here to flush messgaes delivery report from kafak
		# we don't care about the details for now, so calling it to timeout 0
		# means it returns immmeditaly and has very little performace impact
		p.poll(0)
