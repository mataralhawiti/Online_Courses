...
n_components = 150 #150 # [10, 15, 25, 50, 100, 250]
...
second PC has second-largest variance, and so on. 
How much of the variance is explained by the first principal component? The second?
"""
print "#################################################3"
print pca.explained_variance_ratio_[0] #first PC
print pca.explained_variance_ratio_[1] # second PC